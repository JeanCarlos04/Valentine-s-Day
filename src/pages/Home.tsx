...
function Home() {
  ...
  return (
    <section
      className={` p-4 bg-[url('/imgs/minimoss.gif')] h-full bg-cover bg-black-50/20 rounded-md items-center left-24 flex flex-col gap-10`}
    >
      <header className="relative flex flex-col gap-1 text-5xl ">
        ...
        <h2 className="floatingAnimation flex items-center gap-2 text-center text-4xl text-[#f67b90] stroke-text ">
          QUEST <img className="size-8" src="/imgs/HeartLogo.png" />
        </h2>
